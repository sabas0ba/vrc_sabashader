{
    ...
    half3 bankObjectNormal = normalize(mul(vertex.N, (half3x3)unity_ObjectToWorld));
    half3 bankObjectOffset = SBSBankMorphOffset(bankObjectPosition, bankObjectNormal, bankStyle);
    vertex.position += mul((half3x3)unity_ObjectToWorld, bankObjectOffset);
}
