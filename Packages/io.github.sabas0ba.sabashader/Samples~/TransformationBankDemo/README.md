...
第三者のAvatarや衣装assetを使用せず、Capsule、Cylinder、Sphereの3形状で被覆関係を表示します。
...
4. Play Modeへ入り、Arcane、Cyber、Astral、Gaia、Umbra、Flame、Shatter、Glitch、Meltを確認します。

上2段は9 Styleを同じProgressで自動再生します。下段はProgress 0、0.25、0.5、0.75、1の
...
| 全体を覆うSphere | Safety Cover | 衣装切り替え中の不透明な被覆 |
...
このSampleのprimitiveは時間的な被覆関係を示すためのものです。実際のAvatarでは、モデルに合う
