#ifndef SABASHADER_ACRYLIC2D_COMMON_INCLUDED
...
void SCVertexPost(inout SCVertexData vertex, SCPositionAndDirection camera, SCPositionAndDirection head, SCPositionAndDirection headBone, half3 L)
{
    __SC_PHASE_postvertex__
        ...
        vertex.position += normalize(vertex.N) * (_WhiteBorderWidth + _RimWidth);
    #endif
    #ifdef SBS_PASS_RIM
        vertex.position += normalize(vertex.N) * _RimWidth;
    #endif
}
...
#endif // SABASHADER_ACRYLIC2D_COMMON_INCLUDED
